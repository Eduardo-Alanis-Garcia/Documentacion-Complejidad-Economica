...
![](Img/Clasificacion_ramas_DENUE.png)

No se dará una explicación detallada del código.

```{r balassa_modificado_abrir}
directorio = "Datos/Originales/Hidalgo/"
archivos_csv = list.files(path = directorio, 
                          pattern = ".csv", 
                          all.files = T, 
...
# Actualización de Actividades_ComplejidadGIF

![](Img/Actividades_Economicas_GIF.png)

Sin explicación.

## Creación de Rasters

```{r actividad_complejidad_GIF}
#| message: false
#| warning: false
directorio = "Datos/Originales/Hidalgo/"
archivos_csv = list.files(path = directorio, 
